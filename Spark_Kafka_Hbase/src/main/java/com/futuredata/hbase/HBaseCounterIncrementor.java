...
import com.futuredata.hbase.CounterMap;
import com.futuredata.hbase.CounterMap.Counter;
...
public class HBaseCounterIncrementor {
  ...
  static long flushInterval=6000l;
...
//   rowKeyCounterMap = new HashMap<String, CounterMap>();
//   hTable = null;
